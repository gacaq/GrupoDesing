...
class AlarmsControllerTest < ActionController::TestCase
  ...
  test "should create alarm" do
    assert_difference('Alarm.count') do
      post :create, alarm: { alarm_type: @alarm.alarm_type, description: @alarm.description, recipe_id: @alarm.recipe_id }
    end
  ...
  test "should update alarm" do
    put :update, id: @alarm, alarm: { alarm_type: @alarm.alarm_type, description: @alarm.description, recipe_id: @alarm.recipe_id }
    assert_redirected_to alarm_path(assigns(:alarm))
  end
